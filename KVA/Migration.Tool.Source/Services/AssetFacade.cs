        ...
        ) : IAssetFacade
{
    ...
    internal static readonly FormField LegacyMediaFileReleaseDateField = new()
    {
        Column = "LegacyMediaFileReleaseDate",
        ColumnType = "datetime",
        AllowEmpty = true,
        Visible = true,
        Enabled = true,
        Guid = new Guid("82dc24cd-199c-4f8a-a0f8-65b03597dcff"),
        Properties = new FormFieldProperties { FieldCaption = "Release date" },
        Settings = new FormFieldSettings
        {
            ControlName = DateTimeInputComponent.IDENTIFIER
        }
    };
    ...
    public static readonly DataClassModel LegacyMediaFileContentType = new()
    {
        ...
        Fields =
            [
                ...
                LegacyMediaFileReleaseDateField
            ]
    };
